/* Second Brain OS V103 — perfect alignment, compact analytics and stable visual identity. */
'use strict';
((root) => {
  const build = Object.freeze({
    version: '103.0.0',
    major: 103,
    label: 'V103 · PERFECT ALIGNMENT',
    id: 'second-brain-os-v103-perfect-alignment-20260728-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v103-r1',
    cacheName: 'second-brain-os-v103-perfect-alignment-r1',
    builtAt: '2026-07-28T18:30:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

/* Second Brain OS V101 — UI truth, category state and interaction fixes. */
'use strict';
((root) => {
  const build = Object.freeze({
    version: '101.0.0',
    major: 101,
    label: 'V101 · UI TRUTH FIX',
    id: 'second-brain-os-v101-ui-truth-fix-20260728-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v101-r1',
    cacheName: 'second-brain-os-v101-ui-truth-fix-r1',
    builtAt: '2026-07-28T08:00:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

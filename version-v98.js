...
((root) => {
  const build = Object.freeze({
    version: '98.0.0',
    major: 98,
    label: 'V98 · LOAD RECOVERY',
    id: 'second-brain-os-v98-load-recovery-20260727-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v98-r1',
    cacheName: 'second-brain-os-v98-load-recovery-r1',
    builtAt: '2026-07-27T12:00:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

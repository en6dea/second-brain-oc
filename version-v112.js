...
((root) => {
  const build = Object.freeze({
    version: '112.0.0',
    major: 112,
    label: 'V112 · CONNECTED FINANCE',
    id: 'second-brain-os-v112-finance-center-20260809-r8',
    dataSchemaVersion: 3,
    cacheVersion: 'v112-r8',
    cacheName: 'second-brain-os-v112-finance-center-r8',
    builtAt: '2026-08-09T12:00:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

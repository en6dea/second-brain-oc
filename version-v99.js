/* Second Brain OS V98 — emergency load recovery and single build source. */
'use strict';
((root) => {
  const build = Object.freeze({
    version: '99.0.0',
    major: 99,
    label: 'V99 · CATEGORY READABILITY',
    id: 'second-brain-os-v99-category-readability-20260727-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v99-r1',
    cacheName: 'second-brain-os-v99-category-readability-r1',
    builtAt: '2026-07-27T14:30:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

/* Second Brain OS V98 — non-destructive pre-update backup. */
'use strict';
(() => {
  const STORE_KEY='secondBrainOS.v1';
  const build=window.SecondBrainBuild||{major:98,id:'second-brain-os-v98',label:'V98'};

(function(){
  ...
  navigator.serviceWorker?.addEventListener?.('controllerchange',()=>{try{if(sessionStorage.getItem('sbos-v91-r1-reloaded')==='1')return;sessionStorage.setItem('sbos-v91-r1-reloaded','1');location.reload();}catch(_){location.reload();}});

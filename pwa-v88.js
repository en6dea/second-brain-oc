(function(){
  ...
  navigator.serviceWorker?.addEventListener?.('controllerchange',()=>{try{if(sessionStorage.getItem('sbos-v90-r2-reloaded')==='1')return;sessionStorage.setItem('sbos-v90-r2-reloaded','1');location.reload();}catch(_){location.reload();}});

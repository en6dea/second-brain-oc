(function(){
  ...
  navigator.serviceWorker?.addEventListener?.('controllerchange',()=>{try{if(sessionStorage.getItem('sbos-v89-reloaded')==='1')return;sessionStorage.setItem('sbos-v89-reloaded','1');location.reload();}catch(_){location.reload();}});

(function(){
  ...
  navigator.serviceWorker?.addEventListener?.('controllerchange',()=>{try{if(sessionStorage.getItem('sbos-v885-reloaded')==='1')return;sessionStorage.setItem('sbos-v885-reloaded','1');location.reload();}catch(_){location.reload();}});

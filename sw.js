const CACHE_NAME='second-brain-os-v33-polina-root-fix-20260701';
const ASSETS=['./','./index.html','./app-v33-polina-root-fix.js','./app.js','./manifest.webmanifest','./offline.html'];

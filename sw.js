const CACHE_NAME = 'second-brain-os-v48-clean-baseline-private-20260630';
const STATIC_ASSETS = ['./offline.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./maskable-512.png'];
...
self.addEventListener('fetch', event => {
  ...
  if(url.searchParams.has('hard') || url.pathname.endsWith('/index.html') || url.pathname.endsWith('/second-brain-oc/') || url.pathname.endsWith('/second-brain-oc')) {

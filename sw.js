const CACHE_NAME = 'second-brain-os-v46-6-light-tech-visual-safe-20260630';
...
self.addEventListener('fetch', event => {
  ...
  if(url.searchParams.has('hard')) { event.respondWith(fetch(req, {cache:'reload'}).catch(()=>caches.match('./offline.html'))); return; }

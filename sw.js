const CACHE_NAME='second-brain-os-v32-buttons-only-hard-fix-20260701';
const ASSETS=['./','./index.html','./app-v32-root-cause-fix.js','./app.js','./manifest.webmanifest','./offline.html'];

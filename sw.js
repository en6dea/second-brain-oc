const CACHE_NAME='second-brain-os-v8612-r1';
const CORE=['./','./index.html','./manifest.webmanifest','./offline.html','./icon-192-v84.png','./icon-512-v84.png','./maskable-512-v84.png','./pwa-v8612.js','./cloud-sync.js','./firebase-config.js'];

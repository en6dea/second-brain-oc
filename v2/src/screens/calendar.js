...
import { esc, toKey, parseKey, todayKey, monthTitle, monthKey, money, plural } from '../format.js?v=2.2.0';
import { openTasks, activeDebts, debtDue, debtMinimum } from '../calc.js?v=2.2.0';
import { pageHead, card, label, button, metricStrip } from '../ui.js?v=2.2.0';

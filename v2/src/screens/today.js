...
import { greeting, dateWithWeekday, todayKey, money, esc, plural, dateShort } from '../format.js?v=2.2.0';
import {
...
} from '../calc.js?v=2.2.0';
import { pageHead, card, label, ring, button, metricStrip, empty } from '../ui.js?v=2.2.0';

/* Second Brain OS V102 — visual consistency, contextual guidance and dashboard clarity. */
'use strict';
((root) => {
  const build = Object.freeze({
    version: '102.0.0',
    major: 102,
    label: 'V102 · VISUAL GUIDANCE',
    id: 'second-brain-os-v102-visual-guidance-20260728-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v102-r1',
    cacheName: 'second-brain-os-v102-visual-guidance-r1',
    builtAt: '2026-07-28T12:00:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',

/* Second Brain OS V105 — HP journal render fix and GameLife recovery. */
'use strict';
((root) => {
  const build = Object.freeze({
    version: '105.0.0',
    major: 105,
    label: 'V105 · HP JOURNAL FIX',
    id: 'second-brain-os-v105-hp-journal-fix-20260728-r1',
    dataSchemaVersion: 1,
    cacheVersion: 'v105-r1',
    cacheName: 'second-brain-os-v105-hp-journal-fix-r1',
    builtAt: '2026-07-28T20:10:00+03:00',
    criticalFiles: [
      './index.html',
      './offline.html',
